                    ...
                    $geminiResponse = Http::timeout(30)->withHeaders([
                        ...
                        'contents' => [[
                            'parts' => [
                                ...
                                [
                                    'text' => "Kamu adalah AI Senior Data Analyst. BACA GAMBAR INI DENGAN SANGAT TELITI! DATA INI KRUSIAL UNTUK LAPORAN KEUANGAN PERUSAHAAN. JANGAN PERNAH MENGARANG ANGKA! Ini adalah screenshot statistik live (Shopee Seller Center atau TikTok Live) dari akun '{$this->accountName}'. Ekstrak metrik berikut HANYA BERDASARKAN APA YANG TERTULIS DI GAMBAR: 1. Total GMV ('Penjualan (Rp)'/'Omset'). 2. Total Pesanan. 3. Produk Terjual. 4. Total Dilihat (Penonton Kumulatif). 5. Penonton Tertinggi. 6. Nama Platform (Shopee/TikTok/Lainnya). JANGAN MENEBAK-NEBAK DATA! Jika data benar-benar tidak ada di gambar, isi 0. Balas HANYA JSON mentah tanpa markdown: {\"gmv\": angka, \"pesanan\": angka, \"produk_terjual\": angka, \"penonton\": angka, \"penonton_tertinggi\": angka, \"platform\": \"Shopee/TikTok/Lainnya\"}. Hapus titik/koma dari angka (misal 523.680 jadi 523680)."
                                ]
                            ]
                        ]]
                    ]);
